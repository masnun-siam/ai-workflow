...
3. Flag anything vague enough to be unverifiable (e.g. "the auth code" with no path) as
   a gap, not a pass — the whole point is that a reader shouldn't have to take this on
   faith.
